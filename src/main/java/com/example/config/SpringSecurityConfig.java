...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers("/user/{id}/**", "/account/{id}/**", "/payments/{id}/**").access("hasRole('ADMIN') or @webSecurity.checkUserId(authentication, #id)")
                .antMatchers("/role/**", "/currency/**", "/user/**", "/account/**", "/payments/**", "/film/**", "/hall/**", "/show/**").access("hasRole('ADMIN')")
